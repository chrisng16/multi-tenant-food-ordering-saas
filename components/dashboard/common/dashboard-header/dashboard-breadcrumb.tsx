...
export function DashboardBreadcrumb({ pathname, currentStoreName }: DashboardBreadcrumbProps) {
    ...
    // Special handling for stores/[id] - show "Stores -> Store Name"
    if (dashboardSegments[0] === 'stores' && dashboardSegments.length > 1 && currentStoreName) {
        return (
            <Breadcrumb>
                <BreadcrumbList>
                    <BreadcrumbItem>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbPage>{currentStoreName}</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
        )
